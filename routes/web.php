...
Route::put('comment/make/{comment}', [CommentController::class,'store'])->name('comments.update');
...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/comments/answer/{id}', [CommentController::class, 'comment'])->name('comments.answer');
